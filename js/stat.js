...
var names_y = CLOUD_Y+CLOUD_HEIGHT-CLOUD_PADDING;
var column_y =  CLOUD_Y+CLOUD_HEIGHT-CLOUD_PADDING-LINE_HEIGHT;
...
window.renderStatistics = function(ctx, players, times) {
  ...
  for (var i = 0; i<players.length; i++) {
    ctx.fillStyle = "#000";
    ctx.fillText(players[i], CLOUD_X+CLOUD_PADDING+(COLUMN_WIDTH+COLUMN_GAP)*i, names_y);
    ...
    ctx.fillRect(CLOUD_X+CLOUD_PADDING+(COLUMN_WIDTH+COLUMN_GAP)*i, column_y, COLUMN_WIDTH, -columnHeight);
